 ...
 * @link https://github.com/AlexKratky/RestAPI/         Github Repository
 * @author Alex Kratky <alex@panx.dev>
 * @copyright Copyright (c) 2020 Alex Kratky
 * @license http://opensource.org/licenses/mit-license.php MIT License
 * @description REST API class. Part of panx-framework.
 */
...
class RestAPI {
    ...
    public function __construct(Auth $auth = null, $needToBeLogined = true, $get = array(), $create = array(), $update = array(), $delete = array()) {
        $this->auth = $auth;
    ...
    public function checkLogin() {
        if(!$this->needToBeLogined) return true;
